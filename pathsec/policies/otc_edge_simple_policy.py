...
from bgpy.simulation_engine import OnlyToCustomersSimplePolicy

if TYPE_CHECKING:
    from bgpy.simulation_engine import Announcement as Ann


class OnlyToCustomersEdgeSimplePolicy(OnlyToCustomersSimplePolicy):
    name: str = "OnlyToCustomersEdgeSimplePolicy"

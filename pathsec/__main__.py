...
from .sims import (
    run_forged_origin_hijack_sim,  # noqa
    run_forged_origin_hijack_transit_sim,  # noqa
    run_neighbor_spoofing_hijack_sim,  # noqa
    run_shortest_path_hijack_sim,  # noqa
    run_forged_origin_hijack_adoption_scenarios_sim,  # noqa
    run_route_leak_adoption_scenarios_sim,  # noqa
    run_shortest_path_hijack_input_clique_sim,  # noqa
    run_shortest_path_hijack_etc_sim,  # noqa
    run_shortest_path_hijack_etc_cc_sim,  # noqa
    run_route_leak_mh_sim,  # noqa
    run_route_leak_transit_sim,  # noqa
    run_post_rov_motivation_sim,  # noqa
    prob_funcs,  # noqa
    run_shortest_path_hijack_etc_cc_w_bgp_sim,
...
def main():
    ...
    sim_funcs = [
        run_strongest_attack_sim,
        run_forged_origin_hijack_sim,  # before was <3m, now it's 13
        run_shortest_path_hijack_sim,
        run_route_leak_adoption_scenarios_sim,
        run_forged_origin_hijack_adoption_scenarios_sim,
        run_forged_origin_hijack_transit_sim,
        run_shortest_path_hijack_etc_cc_w_bgp_sim,
        run_neighbor_spoofing_hijack_sim,
        partial(run_shortest_path_hijack_sim, num_attackers=10),
        run_route_leak_mh_sim,
        run_route_leak_transit_sim,
        run_shortest_path_hijack_input_clique_sim,
        run_shortest_path_hijack_etc_sim,
        run_shortest_path_hijack_etc_cc_sim,
    ]
